      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          ...
          <button 
            ...
            className="text-[12px] font-bold text-indigo-600 hover:underline cursor-pointer tracking-tight bg-transparent border-none p-0"
          >
            View All Explorer
          </button>
        </div>
